...
d={'hidden_layer': 32, 'hidden_channel': 64, 'param_prop': 0.9, 'param_before': 0.2, 'param_first': 0.5, 'param_ani': 0.01, 'PPR_num': 10, 'lamda1': 0.4, 'lamda2': 0.3, 'gamma': 0.1,'label_beta': 0.8, 'epoch': 300, 'knn_num': 7, 'weight_decay': 0.0001, 'lr_decay': 100, 'lr': 0.01, 'dropout': 0.7, 'an_beta': 1.0, 'd_0_rate': 0.99,'head_num':4}
f(**d)
